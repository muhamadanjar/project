...
<div class="login-box">
  <div class="login-logo">
    <img class="img-logo img-responsive" width="70%" src="{{ asset('assets/img/logo.png')}}" alt="User profile picture" data-pin-nopin="true">
  </div>
  
  <div class="login-box-body">
    <p class="login-box-msg"></p>
    <div class="title">SISMIOP</div>
    <div class="title_planar"></div>
