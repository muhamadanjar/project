...
var geocoderToolInit = (function() {
  ...
  var updateSearchControlFromState = function() {
    ...
    document.getElementById('bias-viewport-checkbox').checked =
        state.viewportBias;
    document.getElementById('new-forward-geocoder-checkbox').checked =
        state.newForwardGeocoder;
  ...
  return function() {
    ...
    // Re-geocode an address when the "new forward geocoder" checkbox is
    // clicked.
    google.maps.event.addDomListener(
        document.getElementById('new-forward-geocoder-checkbox'), 'click',
        updateStateFromSearchControl);
