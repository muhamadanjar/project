...
(function($, window, document){
                    ...
                    '<div class="input-group margin">' +
                        '<div class="input-group-btn">' +
                            ...
                            '<ul class="dropdown-menu">' +
                                ...
                                '<li data-title="Hapus Layer" data-message="Pengaturan Pop Up ??"><a class="settingpopup">Setting Pop Up</a></li>' +
                                '<li data-title="Hapus Layer" data-message="Hapus Data Esri ??"><a class="hapusdataesri">Hapus Data Esri</a></li>' +
                            '</ul>' +
                        '</div>' +
                    '</div>' 
                ,
    ...
    $('#table_layer tbody').on('click', 'a',function(e) {
        ...
        if ($(this).hasClass('edit')) {
        ...
        }else if($(this).hasClass('settingpopup')){
            document.location ='/layers/'+id+'/layerinfo';
        }else if($(this).hasClass('hapusdataesri')){
            e.preventDefault();
            var el = $(this).parent();
            var title = el.attr('data-title');
            var msg = el.attr('data-message');
            var dataForm = el.attr('data-form');
            var newForm = jQuery('<form>', {
                'action': '/layers/'+id+'/layeresrihapus',
                'target': '_top',
                'method' : 'post',
            }).append(jQuery('<input>', {
                'name': '_method',
                    ...
                    '<div class="input-group margin">' +
                        '<div class="input-group-btn">' +
                            ...
                            '<ul class="dropdown-menu">' +
                                ...
                                '<li data-title="Edit Peta" data-message="Edit Letak posisi ??"><a class="editmap">Edit Map</a></li>' +
                            '</ul>' +
                        '</div>' +
                    '</div>' 
                ,
